...
class Road(Model):
    def __init__(self, length=100, n_cars=50, max_speed=100, timestep=1, step_count = 10000, n_lanes=1):
        super().__init__()
    ...
    def add_car(self, truck = False, pos=(0, 0)):
        ...
        car = Car(self.n_agents, self, pref_speed, pref_speed, init_lane=lane, truck=truck)
